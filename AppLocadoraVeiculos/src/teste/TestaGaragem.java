...
public class TestaGaragem {
	...
	public static void main(String[] args) {
		...
		Passeio gol = new Passeio("Gol", "ABC-5050", "Volkswagen", "Motor 1.6", 2015, 50000, 15000);
		Passeio uno = new Passeio("Uno", "AXY-1053", "Fiat", "Motor 2.0", 2014, 75000, 20000);
		Passeio gol2 = new Passeio("Gol", "AXT-7050", "Volkswagen", "Motor 1.0", 2017, 40000, 10000);
		Passeio uno2 = new Passeio("Uno", "AGY-1853", "Fiat", "Motor 1.6", 2018, 70000, 18000);
